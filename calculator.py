...
multiply= Button(btns_frame, text='*',width=10, height=3,command=lambda: btn_click('*')).grid(row=1, column=3, columnspan=3, padx=1, pady=1)
...
minus= Button(btns_frame, text='-',width=10, height=3,command=lambda: btn_click('-')).grid(row=2, column=3, columnspan=3, padx=1, pady=1)
...
plus= Button(btns_frame, text='+',width=10, height=3, command=lambda: btn_click('+')).grid(row=3, column=3, columnspan=3, padx=1, pady=1)
